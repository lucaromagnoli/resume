    ...
    with first_page.create(
        ...
        with header.create(
            ...
            header_table.add_row(
                [MultiColumn(1, align="l", data=TextColor("blue", ""))]
            )
...
def create_footer(first_page: PageStyle) -> PageStyle:
    with first_page.create(Foot("C")) as footer:
        with footer.create(
            Tabularx("X X", width_argument=NoEscape(r"\textwidth"))
        ) as footer_table:
            ...
            name = MiniPage(width=NoEscape(r"0.25\textwidth"), pos="t")
            name.append("Luca Romagnoli")

            page = MiniPage(width=NoEscape(r"0.25\textwidth"), pos="t", align="c")
